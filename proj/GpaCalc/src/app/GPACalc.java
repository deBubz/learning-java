...
public class GPACalc {
    Grade[] gradesArr = new Grade[] { new Grade("HD", 7), new Grade("D", 6), new Grade("C", 5), new Grade("P", 4),
            new Grade("F", 0)
            // new Grade("HD", 4), new Grade("D", 3.5), new Grade("C", 2.5), new Grade("P",
            // 1.5), new Grade("F", 0.5)
    };
    ...
    public void printResult() {
        ...
        println("GPA = " + ((float) totalPoint / totalCredit));
        println("******************************************");
    }
